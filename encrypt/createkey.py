...
def sign_file(file_path, private_key_path, saveas_path, hash_algorithm='SHA256'):
    # 读取文件内容
...
def verify_signature(file_path, signature_path, public_key_path, hash_algorithm='SHA256'):
    # 读取文件内容
    with open(file_path, 'rb') as f:
        file_data = f.read()
